...
namespace VentasCal.Datos
{
    public class DBAcceso<TDomainObject> 
    {
        ...
        /// <returns></returns>
        protected DataSet EjecutaProcedimientoDS(string strProcedimiento, IDataParameter[] arrParametros, string tableName)
        {
        ...
        /// <returns></returns>
        protected DataTable EjecutaProcedimientoDT(string strProcedimiento, IDataParameter[] arrParametros)
        {
